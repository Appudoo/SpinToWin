...
namespace EasyUI.PickerWheelUI {
   ...
   public class PickerWheel : MonoBehaviour {
      ...
      [SerializeField] [Range (.2f, 2f)] private float wheelSize = 0.9f ;
      ...
      private List<int> nonZeroChancesIndices = new List<int> () ;
        ...
        [SerializeField] public List<int> spinNumber;
      ...
      public void Spin () {
        ...
        {
            int randomnumber = 0;
            if (GameManager.Instance.Withdrawaltotal <= 400)
            {
                randomnumber = Random.Range(0, spinNumber.Count - 4);
            }
            else
            {
                randomnumber = Random.Range(0, spinNumber.Count);
            }


            while (480 < CheckNumberValid(randomnumber))
            {
                if (GameManager.Instance.Withdrawaltotal <= 400)
                {
                    randomnumber = Random.Range(0, spinNumber.Count - 3);
                }
                else
                {
                    randomnumber = Random.Range(0, spinNumber.Count);
           ...
           // TotalMoney += spinNumber[randomnumber];
            print("Price:::::::" + spinNumber[randomnumber] + ":::::::::::::::" + GameManager.Instance.Withdrawaltotal);
        ...
        int CheckNumberValid(int r)
        {
            int total = GameManager.Instance.Withdrawaltotal + spinNumber[r];
